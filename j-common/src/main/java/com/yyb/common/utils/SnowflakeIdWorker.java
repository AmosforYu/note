...
//                throw new IllegalArgumentException(String.format("worker Id can't be greater than %d or less than 0", maxWorkerId));
            LOG.warn("worker Id {} can't be greater than {} or less than 0", workerId, maxWorkerId);

        }
        if (datacenterId > maxDatacenterId || datacenterId < 0) {
//                throw new IllegalArgumentException(String.format("datacenter Id can't be greater than %d or less than 0", maxDatacenterId));
            LOG.warn("datacenter Id {} can't be greater than {} or less than 0", datacenterId, maxDatacenterId);
        }
        LOG.info("snowflaker datacenterId {}, workerId {}", datacenterId, workerId);
